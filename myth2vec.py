...
characters_more = ['achilles', 'ades', 'adonis', 'aegisthus', 'aeneas', 'agamemnon', 'aizawa', 'ajax', 'akhilleu', 'albus', 'alecto', 'alfred', 'allison', 'amphitrite', 'andromache', 'annabeth', 'anteros', 'antigone', 'antilochus', 'aphrodite', 'apollo', 'apollon', 'arachne', 'ares', 'ariadne', 'artemis', 'arthur', 'asclepius', 'asterion', 'asterius', 'astyanax', 'atalanta', 'athena', 'atlas', 'atropos', 'author', 'automedon', 'aziraphale', 'ben', 'bianca', 'bobby', 'briseis', 'bruce', 'calliope', 'callisto', 'calypso', 'cassandra', 'castiel', 'castor', 'cerberus', 'chaos', 'charon', 'chiron', 'circe', 'clark', 'clay', 'clint', 'clio', 'clotho', 'clytemnestra', 'cronus', 'crowley', 'cupid', 'daedalus', 'daidalos', 'damian', 'daphne', 'darcy', 'dean', 'death', 'deidameia', 'deiphobus', 'demeter', 'derek', 'diana', 'dick', 'diomedes', 'dionusos', 'dionysus', 'draco', 'ebe', 'echidna', 'echo', 'eileithyia', 'ekate', 'electra', 'elene', 'emma', 'enjolras', 'enyo', 'eos', 'ephaistos', 'epimetheus', 'erakles', 'ere', 'erebus', 'erik', 'eris', 'ermes', 'eros', 'estelle', 'estia', 'eurudike', 'eurydice', 'evil', 'frigg', 'gabriel', 'gaia', 'galatea', 'ganymede', 'ginny', 'grantaire', 'greek', 'hades', 'hannibal', 'harmonia', 'harry', 'hebe', 'hecate', 'hector', 'hecuba', 'helen', 'helenus', 'helios', 'hephaestus', 'hera', 'heracles', 'hercules', 'hermes', 'hermione', 'heron', 'hesione', 'hestia', 'huntresses', 'hyacinth', 'hyacinthus', 'hypnos', 'icarus', 'ikaros', 'inanna', 'iphigeneia', 'iphigenia', 'iris', 'isaac', 'james', 'jane', 'jason', 'john', 'jormungandr', 'kassandra', 'kerberos', 'keroberos', 'klutaimnestra', 'kore', 'kronos', 'lachesis', 'laura', 'leda', 'leo', 'leto', 'loki', 'louis', 'lucifer', 'luna', 'lydia', 'maenads', 'maia', 'makaria', 'mary', 'medea', 'medusa', 'megaera', 'melinoe', 'melpomene', 'menelaos', 'menelaus', 'merlin', 'metis', 'midoriya', 'minos', 'minotaur', 'minthe', 'mnemosyne', 'moirai', 'muses', 'mycroft', 'narcissus', 'natasha', 'nemesis', 'neoptolemus', 'nestor', 'nico', 'nyx', 'odin', 'odinn', 'odusseus', 'odysseus', 'orion', 'orpheus', 'pan', 'pandora', 'paris', 'pasiphae', 'patroclus', 'patroklos', 'pegasus', 'peggy', 'peleus', 'penelope', 'pentheus', 'pepper', 'percy', 'persephone', 'perseus', 'peter', 'phobos', 'phoenix', 'piper', 'pollux', 'poseidon', 'priam', 'prometheus', 'psyche', 'pygmalion', 'reader', 'remus', 'rey', 'rhea', 'ron', 'sally', 'sam', 'sansa', 'satyrs', 'selene', 'seraphim', 'sheriff', 'sherlock', 'sir', 'sirens', 'sirius', 'sisyphus', 'steve', 'stiles', 'tartarus', 'technoblade', 'telemachus', 'thalia', 'thanatos', 'themis', 'theseus', 'thetis', 'thor', 'thorr', 'tim', 'tommyinnit', 'tony', 'triton', 'tyndareus', 'typhon', 'uranus', 'wanda', 'wilbur', 'will', 'zagreus', 'zephyrus', 'zeus', 'eros']

men_more = ['achilles', 'ades', 'adonis', 'aegisthus', 'aeneas', 'agamemnon', 'aizawa', 'ajax', 'akhilleu', 'albus', 'alecto', 'alfred', 'anteros', 'antilochus', 'apollo', 'apollon', 'ares', 'arthur', 'asclepius', 'asterion', 'asterius', 'astyanax', 'atlas', 'automedon', 'aziraphale', 'ben', 'bobby', 'bruce', 'castiel', 'castor', 'charon', 'chiron', 'clark', 'clay', 'clint', 'clio', 'cronus', 'crowley', 'cupid', 'daedalus', 'daidalos', 'damian', 'darcy', 'dean', 'deiphobus', 'derek', 'diana', 'dick', 'diomedes', 'dionusos', 'dionysus', 'draco', 'enjolras', 'ephaistos', 'epimetheus', 'erakles', 'erik', 'ermes', 'eros', 'eros', 'ganymede', 'grantaire', 'hades', 'hannibal', 'harry', 'helenus', 'helios', 'hephaestus', 'heracles', 'hercules', 'hermes', 'heron', 'hyacinth', 'hyacinthus', 'hypnos', 'icarus', 'ikaros', 'isaac', 'james', 'jason', 'john', 'kronos', 'loki', 'louis', 'lucifer', 'menelaos', 'menelaus', 'merlin', 'minos', 'mycroft', 'narcissus', 'neoptolemus', 'nestor', 'nico', 'odin', 'odinn', 'odusseus', 'odysseus', 'orion', 'orpheus', 'pan', 'paris', 'peleus', 'pentheus', 'percy', 'perseus', 'peter', 'phobos', 'pollux', 'poseidon', 'priam', 'prometheus', 'pygmalion', 'remus', 'ron', 'seraphim', 'sherlock', 'sirius', 'sisyphus', 'steve', 'stiles', 'technoblade', 'telemachus', 'theseus', 'thor', 'thorr', 'tim', 'tony', 'triton', 'tyndareus', 'typhon', 'uranus', 'wilbur', 'zagreus', 'zephyrus', 'zeus', 'gabriel', 'patroclus', 'patroklos', 'pegasus', 'thanatos']
women_more = ['allison', 'amphitrite', 'andromache', 'annabeth', 'antigone', 'aphrodite', 'arachne', 'ariadne', 'artemis', 'atalanta', 'athena', 'atropos', 'bianca', 'briseis', 'calliope', 'callisto', 'calypso', 'cassandra', 'circe', 'clotho', 'clytemnestra', 'daphne', 'deidameia', 'demeter', 'echo', 'eileithyia', 'ekate', 'electra', 'elene', 'emma', 'enyo', 'eos', 'eris', 'estelle', 'estia', 'eurudike', 'eurydice', 'frigg', 'gaia', 'galatea', 'ginny', 'harmonia', 'hebe', 'hecate', 'hector', 'hecuba', 'helen', 'hera', 'hermione', 'hesione', 'hestia', 'inanna', 'iphigeneia', 'iphigenia', 'iris', 'jane', 'kassandra', 'klutaimnestra', 'kore', 'lachesis', 'laura', 'leda', 'leto', 'luna', 'lydia', 'maia', 'makaria', 'mary', 'medea', 'medusa', 'megaera', 'melinoe', 'melpomene', 'metis', 'midoriya', 'minthe', 'mnemosyne', 'moirai', 'muses', 'natasha', 'nemesis', 'nyx', 'pandora', 'pasiphae', 'peggy', 'penelope', 'pepper', 'persephone', 'psyche', 'rey', 'rhea', 'sally', 'sansa', 'selene', 'sirens', 'thalia', 'themis', 'thetis', 'wanda']
